/**
 * Chọn ca làm và các mốc Vào/Ra thực tế cho một dòng chấm công.
 * Module thuần, không đọc/ghi workbook và không quyết định các chỉ số vi phạm.
 */
import { MINUTES_PER_DAY } from "../constants/attendanceConstants.js";
import { normalizeLookup } from "../employees/employeeModel.js";
import { applyQ7MondayWindow } from "../services/attendance/q7RuleService.js";
...
export function normalizeActualOut(actualIn, actualOut) {
...
export function getShiftKeyFromName(value) {
