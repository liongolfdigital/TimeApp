  ...
  async function upsertMany(records) {
    ...
    const values = records.map(({
      ...
      return {
        ...
        reason: text(safePayload.note ?? safePayload.reason),
        permission: text(safePayload.permissionStatus ?? safePayload.permission),
        creator_code: text(safePayload.creatorCode),
        creator_name: text(safePayload.recordMaker ?? safePayload.creatorName),
